...
async function AddNewLinkPage() {
    ...
    if(!access.canCreate) {      
        return (
            <div className="min-h-screen bg-gradient-to-brn from-gray-50 to-gray-100 p-4 lg:p-8">
  ...
  return (
    ...
    <div>
        <Link
        href = "/dashboard"
        className="inline-flex items-center gap-2 text-purple-600/75
        hover:text-purple-900 transition-colors font-medium "
        >
        <ArrowLeft  className="w-4 h-4"/>
        Back to my Links
        </Link>
